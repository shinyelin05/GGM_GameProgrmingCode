...
public class Enemy1 : MonoBehaviour {
    public static Enemy1 Create1(Vector3 position) {
        Transform pfEnemy1 = GameAssets.Instance.pfEnemy1;
        Transform enemyTransform = Instantiate(pfEnemy1, position, Quaternion.identity);

        Enemy1 enemy1 = enemyTransform.GetComponent<Enemy1>();
        return enemy1;
    }
